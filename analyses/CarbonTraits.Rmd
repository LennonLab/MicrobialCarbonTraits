...
groupA1 <- lm(Prod ~ Resp, 
              data = Phys.l2[Phys.l2$Group == "A" & Phys.l2$Res == "Glu", ])
groupB1 <- lm(Prod ~ Resp, 
              data = Phys.l2[Phys.l2$Group == "B" & Phys.l2$Res == "Glu", ])
groupA <- lm(Prod ~ Resp, data = Phys.l2[Phys.l2$Group == "A", ])
groupB <- lm(Prod ~ Resp, data = Phys.l2[Phys.l2$Group == "B", ])
pred.frameA <- data.frame(Resp = seq(0.5, 3.2, by = 0.1))
pred.frameB <- data.frame(Resp = seq(0.3, 2.7, by = 0.1))
...
axis(1, lwd = 2, labels = c(2, 10, 100, 1000), at = c(0.3, seq(1, 3, 1)), las = 1)
